...
for f in glob.glob(os.path.join(faces_folder_path, "*")):
    ...
    for k, d in enumerate(dets):
        ...
        bigger_image = image[d.top()-20:d.bottom()+20,d.left()-20:d.right()+20]
        images.append((bigger_image, shape))
...
for i in range(0, num_classes):
    ...
    for k, index in enumerate(indices):
        ...
        file_path = os.path.join(output_folder_path,"face_"+str(k)+"_"+str(i)+".jpg")
